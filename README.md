...
Then we were asked to rewrite part of the `openssl` command, rewrite a couple of the cryptographic hashing algorithms it supports and incorporate one into the other.
