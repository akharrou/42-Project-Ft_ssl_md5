...
Then we were asked to rewrite part of the `OpenSSL` program functionality, which meant rewriting a couple of the cryptographic hashing algorithms it supports.
